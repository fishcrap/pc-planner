...
class SimpleDataLoader():
    def __init__(self, dataset, batch_sampler):
        ...
        self._idx_sampler = batch_sampler

    def __len__(self):
        return len(self._idx_sampler)
    
    def __iter__(self):
        self.i = 0
        self._sampler_iter = iter(self._idx_sampler)
        return self
...
class FastDataLoader():
    def __init__(self, dataset, batch_sampler,
                 ...
                 multiprocessing_context=None, prefetch_factor=2,
        ...
        self._index_sampler = batch_sampler
...
class _BaseDataLoaderIter(object):
    def __init__(self, loader: FastDataLoader) -> None:
...
class _SingleProcessDataLoaderIter(_BaseDataLoaderIter):
    def __init__(self, loader):
        ...
        self._dataset_fetcher = dl_utils.fetcher.FastFetcher(self._dataset)
    ...
    def __init__(self, loader):
        ...
        for i in range(self._num_workers):
            ...
            w = multiprocessing_context.Process(
                target=dl_utils.worker._worker_loop,
